                ...
                {isMenuOpen && (
                    <div className={styles.list}>
                        ...
                        >
                            ...
                            <div className={styles.label}>Hide character count</div>
                        </div>
                        <div
                            className={styles.item}
                            onClick={() => {
                        ...
                        >
                            ...
                            <div className={styles.label}>Hide sentence count</div>
                        </div>
                        <hr />
                        <div className={styles.item} onClick={() => setIsSettingsModalOpen(true)}>
                            <div className={styles.icon}>
                        ...
                        >
                            ...
                            <div className={styles.label}>Sign {session === null ? 'in' : 'out'}</div>
                        </div>
                    </div>
                )}
            </div>
                    ...
                    <div className={styles.ctr}>
                        ...
                        <div className={styles.panel}>
                            <div className={styles.sidebar}>
                                ...
                                <div
                                    className={classNames(styles.item, {
                                        [styles.selected]: selectedSetting === 'General',
                                    })}
                                ...
                                <div
                                    className={classNames(styles.item, {
                                        [styles.selected]: selectedSetting === 'Account',
                                    })}
                            ...
                            <div className={styles.content}>
                                ...
                                {selectedSetting === 'General' && (
                                    <div>
                                        <div className={styles.label}>General content</div>
                                        <div>Location</div>
                                        <div>Units</div>
                                    </div>
                                )}
                                ...
                                {selectedSetting === 'Account' && (
                                    <div>
                                        <div className={styles.label}>Account content</div>
                                        <div>Name</div>
                                        <div>Email</div>
                                        <div>Password</div>
                                    </div>
